...
def scrape_all():
    ...
    mars_data = [{"title":'Cerberus Hemisphere Enhanced',
        ...
        #option refer to hemisphere_image_urls & hemisphere_title_urls instead?
 ...
 #Deliverable 2 - Step 3def hemispheres(browser):
...
#already included in code may need to delete 
    #End session 
    browser.quit()
